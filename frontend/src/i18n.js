...
const T = {
  pt: {
    ...
    "keys.gen": "Gerar Key", "keys.label": "Rótulo (opcional, ex: nome do cliente)", "keys.empty": "Nenhuma key gerada ainda.", "keys.confirmDel": "Excluir esta key?", "login.affHint": "Login de afiliado detectado — é só clicar em Entrar.", "nav.affArea": "Área do afiliado", "aff.title": "Afiliados", "aff.subtitle": "Gere as keys dos seus clientes. Você só vê as suas.", "aff.name": "Nome do afiliado (ex: Luan)", "aff.gen": "Criar afiliado", "aff.created": "Afiliado criado", "aff.empty": "Nenhum afiliado ainda.", "aff.del": "Excluir afiliado", "aff.confirmDel": "Excluir este afiliado? As keys que ele criou continuam funcionando.", "aff.needName": "Informe o nome do afiliado.", "aff.filter": "Filtrar por afiliado", "aff.filterAll": "Todas (todos os afiliados)",
    ...
    "bypass.urlHint": "Google Drive/Dropbox: cole o link normal — nós convertemos para download automático. IMPORTANTE: no Drive, deixe o arquivo como \"Qualquer pessoa com o link\", senão o download falha.",
    ...
    "game.coverUpdated": "Capa atualizada", "game.uploading": "Enviando…", "game.fileAdded": "Arquivo adicionado", "game.bypassLinked": "Bypass vinculado por nome", "game.uploadMultiHint": "Dica: selecione vários .lua de uma vez — segure Ctrl (ou Shift) na janela do Windows.", "game.bulkTitle": "Importar vários jogos por arquivos .lua", "game.bulkDesc": "Selecione vários .lua de uma vez. O App ID vem do nome do arquivo (ex: 3321460.lua) e o título é descoberto automaticamente pela Steam. Depois é só adicionar as capas.", "game.bulkPick": "Selecionar arquivos .lua", "game.bulkHint": "Pode selecionar vários de uma vez", "game.bulkDone": "jogo(s) importado(s)", "game.bulkResolved": "título automático", "game.bulkManual": "definir título", "game.bulkEdit": "editar", "game.bulkOr": "ou adicione um por um",
  ...
  en: {
    ...
    "keys.gen": "Generate Key", "keys.label": "Label (optional, e.g. customer name)", "keys.empty": "No keys generated yet.", "keys.confirmDel": "Delete this key?", "login.affHint": "Affiliate login detected — just click Sign in.", "nav.affArea": "Affiliate area", "aff.title": "Affiliates", "aff.subtitle": "Generate your clients\u2019 keys. You only see yours.", "aff.name": "Affiliate name (e.g. Luan)", "aff.gen": "Create affiliate", "aff.created": "Affiliate created", "aff.empty": "No affiliates yet.", "aff.del": "Delete affiliate", "aff.confirmDel": "Delete this affiliate? The keys they created keep working.", "aff.needName": "Enter the affiliate name.", "aff.filter": "Filter by affiliate", "aff.filterAll": "All (every affiliate)",
    ...
    "bypass.urlHint": "Google Drive/Dropbox: paste the normal link — we convert it to a direct download. IMPORTANT: on Drive, set the file to \"Anyone with the link\", otherwise the download fails.",
    ...
    "game.coverUpdated": "Cover updated", "game.uploading": "Uploading…", "game.fileAdded": "File added", "game.bypassLinked": "Bypass linked by name", "game.uploadMultiHint": "Tip: select several .lua at once — hold Ctrl (or Shift) in the Windows dialog.", "game.bulkTitle": "Import many games from .lua files", "game.bulkDesc": "Select several .lua at once. The App ID comes from the file name (e.g. 3321460.lua) and the title is fetched automatically from Steam. Then just add the covers.", "game.bulkPick": "Select .lua files", "game.bulkHint": "You can select several at once", "game.bulkDone": "game(s) imported", "game.bulkResolved": "auto title", "game.bulkManual": "set title", "game.bulkEdit": "edit", "game.bulkOr": "or add one by one",
  ...
  es: {
    ...
    "keys.gen": "Generar Clave", "keys.label": "Etiqueta (opcional, ej: nombre del cliente)", "keys.empty": "Aún no hay claves.", "keys.confirmDel": "\u00bfEliminar esta clave?", "login.affHint": "Login de afiliado detectado — solo pulsa Entrar.", "nav.affArea": "Área del afiliado", "aff.title": "Afiliados", "aff.subtitle": "Genera las claves de tus clientes. Solo ves las tuyas.", "aff.name": "Nombre del afiliado (ej: Luan)", "aff.gen": "Crear afiliado", "aff.created": "Afiliado creado", "aff.empty": "Aún no hay afiliados.", "aff.del": "Eliminar afiliado", "aff.confirmDel": "\u00bfEliminar este afiliado? Las claves que creó siguen funcionando.", "aff.needName": "Indica el nombre del afiliado.", "aff.filter": "Filtrar por afiliado", "aff.filterAll": "Todas (todos los afiliados)",
    ...
    "bypass.urlHint": "Google Drive/Dropbox: pega el enlace normal — lo convertimos a descarga directa. IMPORTANTE: en Drive, deja el archivo como \"Cualquier persona con el enlace\", o la descarga fallará.",
    ...
    "game.coverUpdated": "Portada actualizada", "game.uploading": "Subiendo…", "game.fileAdded": "Archivo añadido", "game.bypassLinked": "Bypass vinculado por nombre", "game.uploadMultiHint": "Consejo: selecciona varios .lua a la vez — mantén Ctrl (o Shift) en la ventana de Windows.", "game.bulkTitle": "Importar varios juegos por archivos .lua", "game.bulkDesc": "Selecciona varios .lua a la vez. El App ID viene del nombre del archivo (ej: 3321460.lua) y el título se obtiene automáticamente de Steam. Luego solo añade las portadas.", "game.bulkPick": "Seleccionar archivos .lua", "game.bulkHint": "Puedes seleccionar varios a la vez", "game.bulkDone": "juego(s) importado(s)", "game.bulkResolved": "título automático", "game.bulkManual": "definir título", "game.bulkEdit": "editar", "game.bulkOr": "o añade uno por uno",
